export default {
  ...
  importantProjects: [
    {
      name: 'Инвестиции во Здраство',
      value: 1.9,
      icon: 'hospital',
      color: '#9b59b6'
    },
    {
      name: 'Радиодифузна дејност',
      value: 1.2,
    ...
    {
      name: 'Подршка на домашни и странски компании',
      value: 2,
      icon: 'building',
      color: '#f1c40f'
    },
    {
      name: 'Транспортна и енергетска инфраструктура',
      value: 9.5,
      icon: 'bus',
      color: '#e74c3c'
    },
    ...
    {
      name: 'Помош за исплата на минимални плати',
      value: 461,
      icon: 'hands-helping',
      color: '#95a5a6'
    },
    {
      name: 'Мерки за вработување',
      value: 988,
      icon: 'briefcase',
      color: '#e67e22'
    }
